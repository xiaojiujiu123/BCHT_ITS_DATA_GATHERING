...
public class TransServiceLocator extends org.apache.axis.client.Service implements com.bcht.webservice.vehicle.client.TransService {
    ...
    public com.bcht.webservice.vehicle.client.Trans_PortType getTrans(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.bcht.webservice.vehicle.client.TransSoapBindingStub _stub = new com.bcht.webservice.vehicle.client.TransSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.bcht.webservice.vehicle.client.Trans_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.bcht.webservice.vehicle.client.TransSoapBindingStub _stub = new com.bcht.webservice.vehicle.client.TransSoapBindingStub(new java.net.URL(Trans_address), this);
                _stub.setPortName(getTransWSDDServiceName());
                return _stub;
            }
        }
