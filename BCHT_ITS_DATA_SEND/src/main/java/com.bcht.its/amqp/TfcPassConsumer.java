...
@RabbitListener(admin = "zwBchtAdmin",bindings =
        {
                @QueueBinding(
                        value = @Queue(value = "ITS_QUEUE_TFCPASS",durable = "true",autoDelete = "false",exclusive = "false"),
...
public class TfcPassConsumer {
    protected static Logger logger = LoggerFactory.getLogger(TfcPassConsumer.class);
    @Autowired
